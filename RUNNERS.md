...
| `runners/spectral/run_hmm_acf_frontier.jl` | `results/diagnostics/hmm_acf_frontier.txt` + `.csv` + `results/hmm_acf_frontier/*.jld2` | Appendix `sec:spectral_rank_xticker` (marginal-vs-ACF Pareto frontier at K = 3; weighted-objective sweep, nondominated sets) |
