...
- Paper update: `Paper_v10.tex` scaffolded 2026-04-22 from v9; v9 joins the frozen reference set with v7 / v8. Extended Evaluation, Semi-Markov Ablation, Conditional VaR, new baselines paragraphs, operational-split discussion, and DiscreteNJ / WJ 5 % VaR failure callout are the outstanding writeup tasks tracked in `plan-equity-paper.md` §16.
