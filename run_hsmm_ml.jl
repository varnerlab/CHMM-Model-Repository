...
# run_hsmm_ml.jl
#
# A1 (REVISION_PLAN_V3_TO_ACCEPT.md). Maximum-likelihood explicit-duration HSMM
# at K ∈ {3, 18} on SPY using Yu (2010) forward-backward over augmented (state,
# duration) pairs. Gaussian emissions, off-diagonal transitions (no self-loops),
# truncated discrete Pareto sojourns with D_max = 200.
#
