...
# Observed moving-block-bootstrap 95% band
plot!(p, τ, obs_ci_lo, fillrange=obs_ci_hi, alpha=0.25, color=_OBS_C, lw=0,
    label="Observed 95% CI (block bootstrap, ℓ = $BLOCK_LEN)");
