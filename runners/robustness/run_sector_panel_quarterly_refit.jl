# =========================================================================== #
# run_sector_panel_quarterly_refit.jl
#
# Peer-review item 5 (R1 W4 / RE4, R3 W2 / RE3): quarterly-refit version of the
# 30-ticker sector-balanced cross-ticker panel. Same protocol as
# run_sector_panel.jl (penalised CHMM-t at K=18, λ=20, N_paths=1000) but with
# the model refit on a 5y rolling window every 63 trading days during the OoS
# window. The quarterly OoS path is the concatenation of per-quarter
# simulations under the refit-at-quarter-start parameters.
#
# Output:
#   results/sector_panel/sector_panel_quarterly_refit.{csv,txt}
# =========================================================================== #
...
println("="^80)
println("  Quarterly-refit cross-ticker panel (peer-review item 5)")
...
open(joinpath(OUT_DIR, "sector_panel_quarterly_refit.csv"), "w") do io
...
open(joinpath(OUT_DIR, "sector_panel_quarterly_refit.txt"), "w") do io
    println(io, "="^104);
