...
const CHECKS = [
    ...
    ("rolling_copula_roll_t", "results/cross_asset/Rolling_Copula_OoS.txt",                "sections/cross_asset_appendix.tex", "0.185"),
    ("rolling_copula_stat_t", "results/cross_asset/Rolling_Copula_OoS.txt",                "sections/cross_asset_appendix.tex", "0.263"),
...
const KEYED = [
    ...
    ("copula_refit_t_mean", "../CHMM-Paper-Repository/results/robustness/rolling_copula_oos.csv",
        r"refit_effect_Student_t_static_rolling_,+mean=([\d.]+)", 3, "0.078", "sections/cross_asset_appendix.tex"),
